    ...
    <div class="container">
        <div class="navigation">
            <ul>
                ...
                ?>
                <li>
                    <a class= "active" href="/admin page/category-admin.php">
                ...
                <div class="admin-content">
                    ...
                    <div class="category_add">
                        ...
                        <form action="brand-add.php" method="post">
                            ...
                            <label for="">Nhập thương mã hiệu sản phẩm <span style="color:red;">*</span></label>
                            <input class = "inputText" name='brand-id' type="text">
                            <label for="">Nhập thương hiệu sản phẩm <span style="color:red;">*</span></label>
                            <input class = "inputText" name='brand-name' type="text">
                            <label for="">Chọn danh mục sản phẩm <span style="color:red;">*</span></label>
                            
                            <button name = 'btn-add-brand' type = "submit">Thêm thương hiệu</button>
                        </form>
                    </div>
                </div>
            </div>
